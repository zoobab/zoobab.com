...
# Dmesg
    ...
    <6>[    0.272213] TCP established hash table entries: 8192 (order: 4, 65536 bytes)
    ...
    <4>[    0.410943] /home/nc.kumar/EUR_REL_ALL/P350_20110122_V10a_0123_EURO_OPEN/android/kernel/drivers/rtc/hctosys.c: unable to open rtc device (rtc0)
    ...
    <5>[    0.518756] 0x000014280000-0x000020000000 : "userdata"
    ...
    <6>[    0.684473] i2c-gpio i2c-gpio.2: using pins 89 (SDA) and 88 (SCL)
    ...
    <6>[    1.214150] mmc1: Slot eject status = 1
    ...
    <6>[    4.136358] [snd.c:snd_ioctl] snd_set_volume 0 0 5
    ...
    <6>[   22.895858] [audpp.c:audpp_dsp_event] ENABLE
    ...
    <6>[   37.160738] ONCRPC_LGE_GET_FLEX_OPERATOR_CODE_PROC return string : 4 , OPEN
    ...
    <6>[   44.928159] ret_string[2] =82, string=82
    ...
    <6>[  120.140579] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    ...
    <6>[  156.354228] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    ...
    <6>[  168.207673] [snd.c:snd_ioctl] snd_set_device 0 1 1
    ...
    <4>[  252.164906] [Accelerometer] accel_power_on() : Power On
    ...
    <6>[  265.281224] [snd.c:snd_ioctl] snd_set_device 0 1 1
    ...
    <7>[  385.693074] msm_batt_late_resume: enter
    <7>[  385.693814] msm_batt_late_resume: exit
    <6>[  385.693874] late_resume: late resume funtion [c0292ee0]
    <4>[  388.069508] save exit: isCheckpointed 1
    <6>[  391.400473] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[  391.401539] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[  391.401921] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[  391.636891] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[  391.636993] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[  391.638144] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[  391.639241] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[  391.640874] [audpp.c:audpp_dsp_event] ENABLE
    <6>[  391.820691] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  393.695691] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  394.073458] save exit: isCheckpointed 1
    <6>[  394.090688] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  394.465696] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  394.815681] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  395.130063] select 1492 (ndroid.settings), adj 7, size 3554, to kill
    <4>[  395.130129] select 1547 (d.process.media), adj 8, size 3887, to kill
    <4>[  395.130179] select 1558 (com.android.mms), adj 8, size 3901, to kill
    <4>[  395.130234] select 1683 (m.android.email), adj 10, size 3825, to kill
    <4>[  395.130288] select 1736 (droid.deskclock), adj 11, size 3616, to kill
    <4>[  395.130363] send sigkill to 1736 (droid.deskclock), adj 11, size 3616
    <4>[  395.133384] select 1492 (ndroid.settings), adj 7, size 3554, to kill
    <4>[  395.133443] select 1547 (d.process.media), adj 8, size 3887, to kill
    <4>[  395.133489] select 1558 (com.android.mms), adj 8, size 3901, to kill
    <4>[  395.133543] select 1683 (m.android.email), adj 10, size 3825, to kill
    <4>[  395.133596] select 1775 (s:FriendService), adj 10, size 3848, to kill
    <4>[  395.133644] select 1795 (equicksearchbox), adj 11, size 3603, to kill
    <4>[  395.133706] send sigkill to 1795 (equicksearchbox), adj 11, size 3603
    <6>[  395.185679] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  395.480689] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  395.830691] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  396.335696] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  396.655691] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  399.079584] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  399.080896] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  399.572913] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  399.578349] [adsp.c:msm_adsp_get] opening module AUDPREPROCTASK
    <6>[  399.579111] [adsp.c:msm_adsp_get] opening module AUDRECTASK
    <6>[  399.580061] [adsp.c:msm_adsp_put] closing module AUDRECTASK
    <6>[  399.580101] [adsp.c:msm_adsp_put] closing module AUDPREPROCTASK
    <6>[  399.580248] [snd.c:snd_ioctl] snd_set_device 0 1 1
    <6>[  399.582231] [snd.c:snd_ioctl] snd_set_device 0 1 0
    <6>[  399.589726] [snd.c:snd_ioctl] snd_set_device 0 1 1
    <6>[  399.590613] [snd.c:snd_ioctl] snd_set_device 0 1 0
    <6>[  399.593276] [adsp.c:msm_adsp_get] opening module AUDPREPROCTASK
    <6>[  399.593984] [adsp.c:msm_adsp_get] opening module AUDRECTASK
    <6>[  399.594943] [snd.c:snd_ioctl] snd_set_device 0 1 1
    <6>[  399.595663] [snd.c:snd_ioctl] snd_set_device 0 1 0
    <6>[  399.596373] [audmgr.c:audmgr_enable] session 0xc069801c
    <6>[  399.597098] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000001
    <6>[  399.597494] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[  399.699921] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[  399.700071] [adsp.c:msm_adsp_enable] enable 'AUDPREPROCTASK'state[0] id[17227132]
    <6>[  399.701774] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPREPROCTASK: READY
    <6>[  399.701889] [adsp.c:msm_adsp_enable] enable 'AUDRECTASK'state[0] id[17227131]
    <6>[  399.703313] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDRECTASK: READY
    <6>[  399.703434] [audio_in.c:audrec_dsp_event] CFG ENABLED
    <6>[  399.703509] [audio_in.c:audrec_dsp_event] PARAM CFG DONE
    <6>[  399.703594] [audio_in.c:audpre_dsp_event] type 0, status_flag 0
    <6>[  399.703646] [audio_in.c:audpre_dsp_event] type 1, status_flag 0
    <6>[  399.703694] [audio_in.c:audpre_dsp_event] type 2, status_flag 0
    <4>[  400.085844] save exit: isCheckpointed 1
    <4>[  406.089088] save exit: isCheckpointed 1
    <4>[  424.062803] save exit: isCheckpointed 1
    <4>[  430.100244] save exit: isCheckpointed 1
    <6>[  439.649234] [adsp.c:msm_adsp_disable] disable 'AUDRECTASK'
    <6>[  439.649306] [audio_in.c:audrec_dsp_event] CFG SLEEP
    <6>[  439.650273] [adsp.c:msm_adsp_disable] disable 'AUDPREPROCTASK'
    <6>[  439.651008] [audmgr.c:audmgr_disable] session 0xc069801c
    <6>[  439.651654] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[  439.661893] [audmgr.c:process_audmgr_callback] DISABLED
    <6>[  439.661986] [adsp.c:msm_adsp_put] closing module AUDRECTASK
    <6>[  439.662051] [adsp.c:msm_adsp_put] closing module AUDPREPROCTASK
    <6>[  439.662366] [snd.c:snd_ioctl] snd_set_device 0 1 1
    <6>[  439.664361] [snd.c:snd_ioctl] snd_set_device 0 1 0
    <6>[  439.668544] [snd.c:snd_ioctl] snd_set_device 0 1 1
    <6>[  439.669374] [snd.c:snd_ioctl] snd_set_device 0 1 0
    <6>[  440.330726] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  440.650504] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  442.087931] save exit: isCheckpointed 1
    <6>[  443.560853] [audpp.c:audpp_dsp_event] DISABLE
    <6>[  443.560893] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[  443.560911] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[  443.563336] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[  443.563388] [audmgr.c:audmgr_disable] session 0xc0697a68
    <6>[  443.565169] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[  443.575536] [audmgr.c:process_audmgr_callback] DISABLED
    <6>[  445.779068] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  445.807174] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[  445.808228] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[  445.810171] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[  445.814231] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[  445.814274] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[  445.815079] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[  445.816183] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[  445.817583] [audpp.c:audpp_dsp_event] ENABLE
    <6>[  446.817499] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  448.072709] save exit: isCheckpointed 1
    <6>[  449.723831] [audpp.c:audpp_dsp_event] DISABLE
    <6>[  449.723904] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[  449.723944] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[  449.724873] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[  449.724943] [audmgr.c:audmgr_disable] session 0xc0697a68
    <6>[  449.726433] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[  449.736626] [audmgr.c:process_audmgr_callback] DISABLED
    <4>[  454.067541] save exit: isCheckpointed 1
    <4>[  460.054623] save exit: isCheckpointed 1
    <4>[  466.053653] save exit: isCheckpointed 1
    <4>[  472.069704] save exit: isCheckpointed 1
    <4>[  478.070433] save exit: isCheckpointed 1
    <6>[  478.313831] request_suspend_state: sleep (0->3) at 478304995067 (2011-09-12 17:29:23.652201690 UTC)
    <6>[  478.315526] early_suspend: early suspend funtion [c0292ecc]
    <6>[  478.315558] early_suspend: early suspend funtion [c02bbfb0]
    <6>[  478.315579] early_suspend: early suspend funtion [c01e5218]
    <6>[  478.315869] early_suspend: early suspend funtion [c028c994]
    <6>[  478.315896] early_suspend: early suspend funtion [c028b5f4]
    <4>[  478.315926] [Touch] ts_set_vreg() onoff:0
    <6>[  478.316051] early_suspend: early suspend funtion [bf001ce4]
    <6>[  478.324266] early_suspend: early suspend funtion [c00c736c]
    <6>[  478.324796] early_suspend: early suspend funtion [c01e7108]
    <6>[  478.324823] early_suspend: early suspend funtion [c01e78a0]
    <6>[  478.579821] early_suspend: early suspend funtion [c01ea1a8]
    <6>[  478.579856] early_suspend: early suspend funtion [c02d91ec]
    <6>[  478.579878] early_suspend: early suspend funtion [c02d91ec]
    <4>[  478.644036] save exit: isCheckpointed 1
    <4>[  484.056059] save exit: isCheckpointed 1
    <4>[  488.600891] Enter wl_iw_control_wl_off
    <4>[  488.605054] Exit wl_iw_control_wl_off
    <4>[  490.054226] save exit: isCheckpointed 1
    <4>[  496.053729] save exit: isCheckpointed 1
    <7>[  499.508846] wlan0: no IPv6 routers present
    <4>[  514.067459] save exit: isCheckpointed 1
    <4>[  646.068063] save exit: isCheckpointed 1
    <6>[  746.211724] request_suspend_state: wakeup (3->0) at 746202893378 (2011-09-12 17:33:51.550100002 UTC)
    <6>[  746.211784] late_resume: late resume funtion [c02d983c]
    <6>[  746.211804] late_resume: late resume funtion [c02d983c]
    <6>[  746.211821] late_resume: late resume funtion [0]
    <6>[  746.211838] late_resume: late resume funtion [c01e7e88]
    <4>[  746.399019] Exited wl_iw_control_wl_on 
    <6>[  746.634279] late_resume: late resume funtion [c01e7e50]
    <6>[  746.644074] late_resume: late resume funtion [c00c7088]
    <6>[  746.644108] late_resume: late resume funtion [bf001cd4]
    <6>[  746.644796] late_resume: late resume funtion [c028b6a0]
    <4>[  746.644819] [Touch] ts_set_vreg() onoff:1
    <6>[  746.658968] late_resume: late resume funtion [c028c968]
    <6>[  746.659063] late_resume: late resume funtion [c01e54f8]
    <6>[  746.659834] late_resume: late resume funtion [c02bc6d8]
    <7>[  746.659851] msm_batt_late_resume: enter
    <7>[  746.661113] msm_batt_late_resume: exit
    <6>[  746.661136] late_resume: late resume funtion [c0292ee0]
    <4>[  748.100494] save exit: isCheckpointed 1
    <4>[  748.743573] STA connect received 1
    <4>[  749.076993] wl_iw_set_hostip: Received IP Address: 192.168.42.224
    <6>[  753.864959] request_suspend_state: sleep (0->3) at 753856105061 (2011-09-12 17:33:59.203306684 UTC)
    <6>[  753.865091] early_suspend: early suspend funtion [c0292ecc]
    <6>[  753.865134] early_suspend: early suspend funtion [c02bbfb0]
    <6>[  753.865174] early_suspend: early suspend funtion [c01e5218]
    <6>[  753.865548] early_suspend: early suspend funtion [c028c994]
    <6>[  753.865594] early_suspend: early suspend funtion [c028b5f4]
    <4>[  753.865646] [Touch] ts_set_vreg() onoff:0
    <6>[  753.865764] early_suspend: early suspend funtion [bf001ce4]
    <6>[  753.866999] early_suspend: early suspend funtion [c00c736c]
    <6>[  753.867748] early_suspend: early suspend funtion [c01e7108]
    <6>[  753.867796] early_suspend: early suspend funtion [c01e78a0]
    <4>[  754.056714] save exit: isCheckpointed 1
    <6>[  754.317816] early_suspend: early suspend funtion [c01ea1a8]
    <6>[  754.317851] early_suspend: early suspend funtion [c02d91ec]
    <6>[  754.317873] early_suspend: early suspend funtion [c02d91ec]
    <4>[  754.360388] save exit: isCheckpointed 1
    <6>[  754.501259] request_suspend_state: wakeup (3->0) at 754492426735 (2011-09-12 17:33:59.839635025 UTC)
    <6>[  754.509151] late_resume: late resume funtion [c02d983c]
    <6>[  754.509183] late_resume: late resume funtion [c02d983c]
    <6>[  754.509199] late_resume: late resume funtion [0]
    <6>[  754.509214] late_resume: late resume funtion [c01e7e88]
    <6>[  755.017144] late_resume: late resume funtion [c01e7e50]
    <6>[  755.031204] late_resume: late resume funtion [c00c7088]
    <6>[  755.031236] late_resume: late resume funtion [bf001cd4]
    <6>[  755.036621] late_resume: late resume funtion [c028b6a0]
    <4>[  755.036641] [Touch] ts_set_vreg() onoff:1
    <6>[  755.048909] late_resume: late resume funtion [c028c968]
    <6>[  755.049016] late_resume: late resume funtion [c01e54f8]
    <6>[  755.049789] late_resume: late resume funtion [c02bc6d8]
    <7>[  755.049806] msm_batt_late_resume: enter
    <7>[  755.050469] msm_batt_late_resume: exit
    <6>[  755.050488] late_resume: late resume funtion [c0292ee0]
    <4>[  760.052401] save exit: isCheckpointed 1
    <4>[  766.070219] save exit: isCheckpointed 1
    <4>[  772.083704] save exit: isCheckpointed 1
    <4>[  778.111854] save exit: isCheckpointed 1
    <4>[  784.100723] save exit: isCheckpointed 1
    <6>[  784.629201] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[  784.630214] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[  784.630516] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[  784.867336] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[  784.867384] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[  784.868309] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[  784.869794] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[  784.871343] [audpp.c:audpp_dsp_event] ENABLE
    <6>[  786.030883] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  787.225886] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  788.410888] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  789.465881] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  790.092568] save exit: isCheckpointed 1
    <6>[  790.300889] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  791.060884] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  791.705881] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  792.130886] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  792.860881] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  793.555879] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[  795.370884] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[  796.055963] save exit: isCheckpointed 1
    <6>[  798.285666] [audpp.c:audpp_dsp_event] DISABLE
    <6>[  798.285733] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[  798.285763] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[  798.286659] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[  798.286716] [audmgr.c:audmgr_disable] session 0xc0697a68
    <6>[  798.287934] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[  798.298684] [audmgr.c:process_audmgr_callback] DISABLED
    <4>[  802.097659] save exit: isCheckpointed 1
    <4>[  808.097146] save exit: isCheckpointed 1
    <4>[  808.100903] save exit: isCheckpointed 1
    <4>[  810.672426] select 1492 (ndroid.settings), adj 8, size 3476, to kill
    <4>[  810.672461] select 1558 (com.android.mms), adj 9, size 3756, to kill
    <4>[  810.672486] select 1683 (m.android.email), adj 10, size 3707, to kill
    <4>[  810.672509] select 1775 (s:FriendService), adj 11, size 3718, to kill
    <4>[  810.672538] send sigkill to 1775 (s:FriendService), adj 11, size 3718
    <4>[  810.752394] select 1492 (ndroid.settings), adj 8, size 3476, to kill
    <4>[  810.752431] select 1558 (com.android.mms), adj 9, size 3756, to kill
    <4>[  810.752456] select 1683 (m.android.email), adj 10, size 3707, to kill
    <4>[  810.752488] select 1830 (com.lge.lgmits), adj 11, size 3270, to kill
    <4>[  810.752519] send sigkill to 1830 (com.lge.lgmits), adj 11, size 3270
    <4>[  814.073354] save exit: isCheckpointed 1
    <4>[  820.086564] save exit: isCheckpointed 1
    <4>[  825.500888] select 1492 (ndroid.settings), adj 9, size 2838, to kill
    <4>[  825.500924] select 1558 (com.android.mms), adj 10, size 3045, to kill
    <4>[  825.500948] select 1683 (m.android.email), adj 11, size 3005, to kill
    <4>[  825.500979] send sigkill to 1683 (m.android.email), adj 11, size 3005
    <4>[  826.084219] save exit: isCheckpointed 1
    <4>[  832.063208] save exit: isCheckpointed 1
    <6>[  835.549519] request_suspend_state: sleep (0->3) at 835540665077 (2011-09-12 17:35:20.887868367 UTC)
    <6>[  835.549623] early_suspend: early suspend funtion [c0292ecc]
    <6>[  835.549666] early_suspend: early suspend funtion [c02bbfb0]
    <6>[  835.549708] early_suspend: early suspend funtion [c01e5218]
    <6>[  835.550081] early_suspend: early suspend funtion [c028c994]
    <6>[  835.550128] early_suspend: early suspend funtion [c028b5f4]
    <4>[  835.550179] [Touch] ts_set_vreg() onoff:0
    <6>[  835.550316] early_suspend: early suspend funtion [bf001ce4]
    <6>[  835.556464] early_suspend: early suspend funtion [c00c736c]
    <6>[  835.557359] early_suspend: early suspend funtion [c01e7108]
    <6>[  835.557408] early_suspend: early suspend funtion [c01e78a0]
    <6>[  835.819809] early_suspend: early suspend funtion [c01ea1a8]
    <6>[  835.819843] early_suspend: early suspend funtion [c02d91ec]
    <6>[  835.819864] early_suspend: early suspend funtion [c02d91ec]
    <4>[  835.867566] save exit: isCheckpointed 1
    <4>[  835.941053] save exit: isCheckpointed 1
    <4>[  838.057469] save exit: isCheckpointed 1
    <4>[  841.831416] select 1492 (ndroid.settings), adj 7, size 2853, to kill
    <4>[  841.831451] select 1547 (d.process.media), adj 9, size 3222, to kill
    <4>[  841.831473] select 1558 (com.android.mms), adj 10, size 3044, to kill
    <4>[  841.831496] select 1720 (viders.calendar), adj 11, size 2885, to kill
    <4>[  841.831521] select 1836 (android.browser), adj 11, size 2902, to kill
    <4>[  841.831549] send sigkill to 1836 (android.browser), adj 11, size 2902
    <4>[  844.059546] save exit: isCheckpointed 1
    <4>[  850.070488] save exit: isCheckpointed 1
    <4>[  856.070148] save exit: isCheckpointed 1
    <4>[  862.076066] save exit: isCheckpointed 1
    <4>[  865.913924] Enter wl_iw_control_wl_off
    <4>[  865.920918] Exit wl_iw_control_wl_off
    <4>[  865.953568] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[  865.954011] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[  865.966144] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[  865.966633] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[  868.069991] save exit: isCheckpointed 1
    <4>[  874.072074] save exit: isCheckpointed 1
    <7>[  876.498846] wlan0: no IPv6 routers present
    <6>[  901.211406] request_suspend_state: wakeup (3->0) at 901202568406 (2011-09-12 17:36:26.549775029 UTC)
    <6>[  901.211509] late_resume: late resume funtion [c02d983c]
    <6>[  901.211544] late_resume: late resume funtion [c02d983c]
    <6>[  901.211561] late_resume: late resume funtion [0]
    <6>[  901.211576] late_resume: late resume funtion [c01e7e88]
    <4>[  901.404017] Exited wl_iw_control_wl_on 
    <6>[  901.557147] late_resume: late resume funtion [c01e7e50]
    <6>[  901.571059] late_resume: late resume funtion [c00c7088]
    <6>[  901.572166] late_resume: late resume funtion [bf001cd4]
    <6>[  901.573131] late_resume: late resume funtion [c028b6a0]
    <4>[  901.573159] [Touch] ts_set_vreg() onoff:1
    <6>[  901.588872] late_resume: late resume funtion [c028c968]
    <6>[  901.588982] late_resume: late resume funtion [c01e54f8]
    <6>[  901.589791] late_resume: late resume funtion [c02bc6d8]
    <7>[  901.589811] msm_batt_late_resume: enter
    <7>[  901.590531] msm_batt_late_resume: exit
    <6>[  901.590554] late_resume: late resume funtion [c0292ee0]
    <4>[  903.776561] STA connect received 1
    <4>[  904.059017] save exit: isCheckpointed 1
    <4>[  904.152097] wl_iw_set_hostip: Received IP Address: 192.168.42.224
    <4>[  910.108422] save exit: isCheckpointed 1
    <4>[  916.083304] save exit: isCheckpointed 1
    <4>[  922.081024] save exit: isCheckpointed 1
    <4>[  928.128714] save exit: isCheckpointed 1
    <4>[  940.067597] save exit: isCheckpointed 1
    <4>[  946.060491] save exit: isCheckpointed 1
    <4>[  952.084552] save exit: isCheckpointed 1
    <4>[  964.073784] save exit: isCheckpointed 1
    <4>[  976.094551] save exit: isCheckpointed 1
    <4>[  982.082082] save exit: isCheckpointed 1
    <4>[  996.647321] gpiomatrix: key e7, 1-0 (33-38) changed to 1
    <4>[  996.788252] gpiomatrix: key e7, 1-0 (33-38) changed to 0
    <4>[  997.429919] gpiomatrix: key e7, 1-0 (33-38) changed to 1
    <4>[  997.530604] gpiomatrix: key e7, 1-0 (33-38) changed to 0
    <6>[  999.454619] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  999.455994] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[  999.484467] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[  999.485392] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[  999.485571] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[  999.720479] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[  999.720581] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[  999.721706] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[  999.722777] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[  999.724409] [audpp.c:audpp_dsp_event] ENABLE
    <6>[  999.745884] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <4>[ 1000.081759] save exit: isCheckpointed 1
    <6>[ 1000.258472] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[ 1003.165774] [audpp.c:audpp_dsp_event] DISABLE
    <6>[ 1003.165857] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[ 1003.165904] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[ 1003.166811] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[ 1003.166884] [audmgr.c:audmgr_disable] session 0xc0697a68
    <6>[ 1003.168124] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[ 1003.179056] [audmgr.c:process_audmgr_callback] DISABLED
    <4>[ 1006.072201] save exit: isCheckpointed 1
    <4>[ 1018.091391] save exit: isCheckpointed 1
    <4>[ 1024.078437] save exit: isCheckpointed 1
    <4>[ 1030.076236] save exit: isCheckpointed 1
    <4>[ 1036.096591] save exit: isCheckpointed 1
    <4>[ 1042.073541] save exit: isCheckpointed 1
    <4>[ 1054.081991] save exit: isCheckpointed 1
    <4>[ 1060.117904] save exit: isCheckpointed 1
    <4>[ 1066.072364] save exit: isCheckpointed 1
    <4>[ 1072.094311] save exit: isCheckpointed 1
    <4>[ 1078.113029] save exit: isCheckpointed 1
    <4>[ 1084.087982] save exit: isCheckpointed 1
    <4>[ 1087.523299] select 1492 (ndroid.settings), adj 7, size 3630, to kill
    <4>[ 1087.523334] select 1547 (d.process.media), adj 8, size 3138, to kill
    <4>[ 1087.523356] select 1558 (com.android.mms), adj 10, size 2958, to kill
    <4>[ 1087.523381] select 1720 (viders.calendar), adj 11, size 2805, to kill
    <4>[ 1087.523412] send sigkill to 1720 (viders.calendar), adj 11, size 2805
    <4>[ 1090.123857] save exit: isCheckpointed 1
    <6>[ 1093.147352] msm_hsusb msm_hsusb: suspend
    <6>[ 1093.157084] VBUS - (OFF)
    <6>[ 1093.157151] msm_hsusb msm_hsusb: msm72k_udc: ONLINE -> OFFLINE
    <6>[ 1093.160147] diag_function_disable
    <7>[ 1093.160597] diag: USB disconnected
    <3>[ 1093.162142] Packet dropped due to bad HDLC coding/CRC errors or partial packet received, packet length = 0
    <3>[ 1093.168117] init: sys_prop: permission denied uid:2000  name:adb.connected
    <6>[ 1093.186994] msm_hsusb_phy_reset
    <6>[ 1093.309052] msm_otg_suspend: usb in low power mode
    <3>[ 1093.372971] init: untracked pid 2280 exited
    <6>[ 1093.671314] smd_close(cd099000)
    <6>[ 1093.671382] smd_close(DS)
    <4>[ 1096.244514] save exit: isCheckpointed 1
    <6>[ 1096.698224] [snd.c:snd_ioctl] snd_set_volume 30 0 3
    <6>[ 1096.728899] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[ 1096.729907] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[ 1096.730064] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[ 1096.967977] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[ 1096.968097] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[ 1096.970724] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[ 1096.975012] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[ 1096.978499] [audpp.c:audpp_dsp_event] ENABLE
    <6>[ 1098.927994] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <6>[ 1101.844622] [audpp.c:audpp_dsp_event] DISABLE
    <6>[ 1101.844737] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[ 1101.844787] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[ 1101.847969] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[ 1101.848081] [audmgr.c:audmgr_disable] session 0xc0697a68
    
    <6>[ 1101.851989] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[ 1101.862529] [audmgr.c:process_audmgr_callback] DISABLED
    <4>[ 1102.223606] save exit: isCheckpointed 1
    <4>[ 1108.115489] save exit: isCheckpointed 1
    <4>[ 1120.402067] save exit: isCheckpointed 1
    <4>[ 1126.552797] save exit: isCheckpointed 1
    <4>[ 1132.454037] save exit: isCheckpointed 1
    <4>[ 1138.378422] save exit: isCheckpointed 1
    <4>[ 1144.217826] save exit: isCheckpointed 1
    <4>[ 1150.883909] save exit: isCheckpointed 1
    <4>[ 1156.818199] save exit: isCheckpointed 1
    <4>[ 1162.304162] save exit: isCheckpointed 1
    <4>[ 1168.458627] save exit: isCheckpointed 1
    <4>[ 1174.540162] save exit: isCheckpointed 1
    <6>[ 1180.702536] request_suspend_state: sleep (0->3) at 1180693646740 (2011-09-12 17:41:06.040845030 UTC)
    <6>[ 1180.702686] early_suspend: early suspend funtion [c0292ecc]
    <6>[ 1180.702732] early_suspend: early suspend funtion [c02bbfb0]
    <6>[ 1180.702776] early_suspend: early suspend funtion [c01e5218]
    <6>[ 1180.703204] early_suspend: early suspend funtion [c028c994]
    <6>[ 1180.703261] early_suspend: early suspend funtion [c028b5f4]
    <4>[ 1180.703321] [Touch] ts_set_vreg() onoff:0
    <6>[ 1180.703631] early_suspend: early suspend funtion [bf001ce4]
    <6>[ 1180.709714] early_suspend: early suspend funtion [c00c736c]
    <6>[ 1180.710854] early_suspend: early suspend funtion [c01e7108]
    <6>[ 1180.710906] early_suspend: early suspend funtion [c01e78a0]
    <4>[ 1180.847482] save exit: isCheckpointed 1
    <6>[ 1181.174387] early_suspend: early suspend funtion [c01ea1a8]
    <6>[ 1181.174421] early_suspend: early suspend funtion [c02d91ec]
    <6>[ 1181.174442] early_suspend: early suspend funtion [c02d91ec]
    <4>[ 1181.779684] save exit: isCheckpointed 1
    <4>[ 1182.005534] save exit: isCheckpointed 1
    <4>[ 1186.413407] save exit: isCheckpointed 1
    <4>[ 1191.446434] Enter wl_iw_control_wl_off
    <4>[ 1191.456646] Exit wl_iw_control_wl_off
    <4>[ 1191.490986] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1191.501821] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1191.546449] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1191.546821] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1192.059436] save exit: isCheckpointed 1
    <4>[ 1198.126486] save exit: isCheckpointed 1
    <7>[ 1201.618881] wlan0: no IPv6 routers present
    <4>[ 1204.111516] save exit: isCheckpointed 1
    <4>[ 1210.076504] save exit: isCheckpointed 1
    <4>[ 1211.200842] save exit: isCheckpointed 1
    <6>[ 1211.278941] PM: Syncing filesystems ... done.
    <4>[ 1211.358946] Freezing user space processes ... (elapsed 0.01 seconds) done.
    <4>[ 1211.374457] Freezing remaining freezable tasks ... (elapsed 0.00 seconds) done.
    <4>[ 1211.374997] Suspending console(s) (use no_console_suspend to debug)
    <4>[ 1211.377002] [Accelerometer] accel_power_off() : Power Off
    <4>[ 1211.377071] [Ecompass] ecom_power_set() : Power Off
    <7>[ 1211.379789] msmrtc_tod_proc_result: 09/12/2011 17:41:36 (00)
    <7>[ 1211.382582] msmrtc_tod_proc_result: 09/12/2011 17:41:36 (00)
    <7>[ 1211.384476] msmrtc_tod_proc_result: 09/12/2011 17:41:36 (00)
    <7>[ 1211.386784] msmrtc_tod_proc_result: 09/12/2011 17:41:36 (00)
    <6>[ 1211.388997] LGE: Android Vibrator Driver Suspend
    <7>[ 1211.389197] <6>[msm_battery] msm_batt_suspend()...
    <6>[ 1211.408294] pecan_pwrsink_suspend_noirq: configure gpio for suspend
    <6>[ 1211.408294] wakeup wake lock: rpcrotuer_smd_xprt
    <6>[ 1211.409176] pecan_pwrsink_resume_noirq: configure gpio for resume
    <3>[ 1211.479154] dhd_late_resume: enter
    <7>[ 1211.485377] <6>[msm_battery] msm_batt_resume()...
    <6>[ 1211.486921] LGE: Android Vibrator Driver Resume
    <7>[ 1211.488767] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <7>[ 1211.490431] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <4>[ 1211.490549] [Ecompass] ecom_power_set() : Power On
    <4>[ 1211.493771] [Accelerometer] accel_power_on() : Power On
    <4>[ 1211.500986] Restarting tasks ... 
    <6>[ 1211.521567] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.541602] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.561634] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.581664] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.601696] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.601742] [LGE] msmsdcc_check_status (last status): old status - 1,  current status - 1
    <4>[ 1211.618521] done.
    <6>[ 1211.618576] suspend: exit suspend, ret = 0 (2011-09-12 17:41:49.628090000 UTC)
    <6>[ 1211.708341] PM: Syncing filesystems ... done.
    <4>[ 1211.788372] Freezing user space processes ... (elapsed 0.01 seconds) done.
    <4>[ 1211.799882] Freezing remaining freezable tasks ... (elapsed 0.00 seconds) done.
    <4>[ 1211.800319] Suspending console(s) (use no_console_suspend to debug)
    <4>[ 1211.801849] [Accelerometer] accel_power_off() : Power Off
    <4>[ 1211.801909] [Ecompass] ecom_power_set() : Power Off
    <7>[ 1211.803429] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <7>[ 1211.804456] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <7>[ 1211.805282] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <7>[ 1211.806511] msmrtc_tod_proc_result: 09/12/2011 17:41:49 (00)
    <6>[ 1211.807544] LGE: Android Vibrator Driver Suspend
    <7>[ 1211.807652] <6>[msm_battery] msm_batt_suspend()...
    <6>[ 1211.821101] pecan_pwrsink_suspend_noirq: configure gpio for suspend
    <6>[ 1211.821391] pecan_pwrsink_resume_noirq: configure gpio for resume
    <6>[ 1211.822301] msm_otg_resume: usb exited from low power mode
    <6>[ 1211.824161] VBUS - (ON)
    <6>[ 1211.824191] wakeup wake lock: usb_bus_active
    <6>[ 1211.824262] msm_hsusb msm_hsusb: msm72k_udc: OFFLINE -> ONLINE
    <6>[ 1211.830666] msm_hsusb_phy_reset
    <3>[ 1211.888674] dhd_late_resume: enter
    <7>[ 1211.894856] <6>[msm_battery] msm_batt_resume()...
    <6>[ 1211.896079] LGE: Android Vibrator Driver Resume
    <7>[ 1211.898107] msmrtc_tod_proc_result: 09/12/2011 17:41:51 (00)
    <7>[ 1211.899199] msmrtc_tod_proc_result: 09/12/2011 17:41:51 (00)
    <4>[ 1211.899387] [Ecompass] ecom_power_set() : Power On
    <4>[ 1211.902421] [Accelerometer] accel_power_on() : Power On
    <4>[ 1211.909251] Restarting tasks ... 
    <6>[ 1211.929724] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.949761] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.969791] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1211.989821] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1212.009852] [LGE] msmsdcc_check_status: old status - 1,  current status - 1
    <6>[ 1212.009899] [LGE] msmsdcc_check_status (last status): old status - 1,  current status - 1
    <4>[ 1212.017182] done.
    <6>[ 1212.017239] suspend: exit suspend, ret = 0 (2011-09-12 17:41:51.617949999 UTC)
    <6>[ 1212.051362] msm_hsusb msm_hsusb: suspend
    <6>[ 1212.142751] request_suspend_state: wakeup (3->0) at 1212134931742 (2011-09-12 17:41:51.743436672 UTC)
    <6>[ 1212.142824] late_resume: late resume funtion [c02d983c]
    <6>[ 1212.142849] late_resume: late resume funtion [c02d983c]
    <6>[ 1212.142869] late_resume: late resume funtion [0]
    <6>[ 1212.142889] late_resume: late resume funtion [c01e7e88]
    <6>[ 1212.207699] msm_hsusb msm_hsusb: reset
    <6>[ 1212.209964] msm_hsusb msm_hsusb: portchange USB_SPEED_HIGH
    <6>[ 1212.330222] msm_hsusb msm_hsusb: reset
    <6>[ 1212.332509] msm_hsusb msm_hsusb: portchange USB_SPEED_HIGH
    <4>[ 1212.369067] Exited wl_iw_control_wl_on 
    <6>[ 1212.482591] android_usb gadget: high speed config #1: android
    <7>[ 1212.482732] diag: USB connected
    <6>[ 1212.494394] SMD: ch 0 0 -> 1
    <6>[ 1212.494486] SMD: ch 0 1 -> 2
    <6>[ 1212.712514] [audmgr.c:audmgr_enable] session 0xc0697a68
    <6>[ 1212.713589] [audmgr.c:process_audmgr_callback] rpc READY handle=0x00000000
    <6>[ 1212.713654] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <6>[ 1212.748399] late_resume: late resume funtion [c01e7e50]
    <6>[ 1212.759462] late_resume: late resume funtion [c00c7088]
    <6>[ 1212.759644] late_resume: late resume funtion [bf001cd4]
    <6>[ 1212.760151] late_resume: late resume funtion [c028b6a0]
    <4>[ 1212.760172] [Touch] ts_set_vreg() onoff:1
    <6>[ 1212.779289] late_resume: late resume funtion [c028c968]
    <6>[ 1212.779391] late_resume: late resume funtion [c01e54f8]
    <6>[ 1212.780159] late_resume: late resume funtion [c02bc6d8]
    <7>[ 1212.780172] msm_batt_late_resume: enter
    <7>[ 1212.780892] msm_batt_late_resume: exit
    <6>[ 1212.780906] late_resume: late resume funtion [c0292ee0]
    <6>[ 1212.950266] [audmgr.c:process_audmgr_callback] rpc CODEC_CONFIG volume=0x00000000
    <6>[ 1212.950372] [adsp.c:msm_adsp_get] opening module AUDPPTASK
    <6>[ 1212.951929] [adsp.c:msm_adsp_enable] enable 'AUDPPTASK'state[0] id[17227122]
    <6>[ 1212.953286] [adsp.c:handle_adsp_rtos_mtoa_app] module AUDPPTASK: READY
    <6>[ 1212.954934] [audpp.c:audpp_dsp_event] ENABLE
    <6>[ 1213.048027] do_detect_factory_cable : Using PIF ZIG (0)
    <6>[ 1213.048727] 
    <6>[ 1213.048741] Charger Type: STD DOWNSTREAM PORT
    <4>[ 1214.687422] STA connect received 1
    <6>[ 1214.904501] [audio_out.c:audio_dsp_event] PCMDMAMISSED 32
    <4>[ 1215.204196] wl_iw_set_hostip: Received IP Address: 192.168.42.224
    <4>[ 1216.090897] save exit: isCheckpointed 1
    <3>[ 1217.161231] init: sys_prop: permission denied uid:2000  name:adb.connected
    <6>[ 1217.796151] [audpp.c:audpp_dsp_event] DISABLE
    <6>[ 1217.796239] [audpp.c:audpp_disable] Received CFG_MSG_DISABLE from ADSP
    <6>[ 1217.796284] [adsp.c:msm_adsp_disable] disable 'AUDPPTASK'
    <6>[ 1217.797456] [adsp.c:msm_adsp_put] closing module AUDPPTASK
    <6>[ 1217.797547] [audmgr.c:audmgr_disable] session 0xc0697a68
    <6>[ 1217.798686] [audmgr.c:audmgr_rpc_thread] rpc_reply status 0
    <3>[ 1217.808927] [audmgr.c:process_audmgr_callback] DISABLED
    <4>[ 1222.074399] save exit: isCheckpointed 1
    <4>[ 1234.073896] save exit: isCheckpointed 1
    <4>[ 1240.073614] save exit: isCheckpointed 1
    <6>[ 1242.174589] request_suspend_state: sleep (0->3) at 1242166755081 (2011-09-12 17:42:21.775256678 UTC)
    <6>[ 1242.174701] early_suspend: early suspend funtion [c0292ecc]
    <6>[ 1242.174744] early_suspend: early suspend funtion [c02bbfb0]
    <6>[ 1242.174784] early_suspend: early suspend funtion [c01e5218]
    <6>[ 1242.175156] early_suspend: early suspend funtion [c028c994]
    <6>[ 1242.175202] early_suspend: early suspend funtion [c028b5f4]
    <4>[ 1242.175252] [Touch] ts_set_vreg() onoff:0
    <6>[ 1242.175374] early_suspend: early suspend funtion [bf001ce4]
    <6>[ 1242.181082] early_suspend: early suspend funtion [c00c736c]
    <6>[ 1242.181896] early_suspend: early suspend funtion [c01e7108]
    <6>[ 1242.181944] early_suspend: early suspend funtion [c01e78a0]
    <6>[ 1242.467491] early_suspend: early suspend funtion [c01ea1a8]
    <6>[ 1242.467522] early_suspend: early suspend funtion [c02d91ec]
    <6>[ 1242.467544] early_suspend: early suspend funtion [c02d91ec]
    <4>[ 1252.071399] save exit: isCheckpointed 1
    <4>[ 1252.549826] Enter wl_iw_control_wl_off
    <4>[ 1252.553732] Exit wl_iw_control_wl_off
    <4>[ 1252.600277] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1252.600669] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1252.628366] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1252.628674] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1258.071496] save exit: isCheckpointed 1
    <7>[ 1262.957837] wlan0: no IPv6 routers present
    <4>[ 1264.071696] save exit: isCheckpointed 1
    <6>[ 1268.234912] request_suspend_state: wakeup (3->0) at 1268227091742 (2011-09-12 17:42:47.835598339 UTC)
    <6>[ 1268.235632] late_resume: late resume funtion [c02d983c]
    <6>[ 1268.235657] late_resume: late resume funtion [c02d983c]
    <6>[ 1268.235672] late_resume: late resume funtion [0]
    <6>[ 1268.235689] late_resume: late resume funtion [c01e7e88]
    <4>[ 1268.413364] Exited wl_iw_control_wl_on 
    <6>[ 1268.589111] late_resume: late resume funtion [c01e7e50]
    <6>[ 1268.594877] late_resume: late resume funtion [c00c7088]
    <6>[ 1268.595707] late_resume: late resume funtion [bf001cd4]
    <6>[ 1268.596572] late_resume: late resume funtion [c028b6a0]
    <4>[ 1268.596597] [Touch] ts_set_vreg() onoff:1
    <6>[ 1268.607892] late_resume: late resume funtion [c028c968]
    <6>[ 1268.607981] late_resume: late resume funtion [c01e54f8]
    <6>[ 1268.609019] late_resume: late resume funtion [c02bc6d8]
    <7>[ 1268.609037] msm_batt_late_resume: enter
    <7>[ 1268.609762] msm_batt_late_resume: exit
    <6>[ 1268.609781] late_resume: late resume funtion [c0292ee0]
    <4>[ 1270.802116] STA connect received 1
    <4>[ 1271.138579] wl_iw_set_hostip: Received IP Address: 192.168.42.224
    <4>[ 1276.056641] save exit: isCheckpointed 1
    <4>[ 1282.073532] save exit: isCheckpointed 1
    <6>[ 1302.024899] request_suspend_state: sleep (0->3) at 1302017056745 (2011-09-12 17:43:21.625558341 UTC)
    <6>[ 1302.025007] early_suspend: early suspend funtion [c0292ecc]
    <6>[ 1302.025049] early_suspend: early suspend funtion [c02bbfb0]
    <6>[ 1302.025091] early_suspend: early suspend funtion [c01e5218]
    <6>[ 1302.025462] early_suspend: early suspend funtion [c028c994]
    <6>[ 1302.025509] early_suspend: early suspend funtion [c028b5f4]
    <4>[ 1302.025559] [Touch] ts_set_vreg() onoff:0
    <6>[ 1302.025697] early_suspend: early suspend funtion [bf001ce4]
    <6>[ 1302.031477] early_suspend: early suspend funtion [c00c736c]
    <6>[ 1302.032282] early_suspend: early suspend funtion [c01e7108]
    <6>[ 1302.032329] early_suspend: early suspend funtion [c01e78a0]
    <6>[ 1302.284727] early_suspend: early suspend funtion [c01ea1a8]
    <6>[ 1302.284759] early_suspend: early suspend funtion [c02d91ec]
    <6>[ 1302.284781] early_suspend: early suspend funtion [c02d91ec]
    <4>[ 1302.333111] save exit: isCheckpointed 1
    <4>[ 1306.071252] save exit: isCheckpointed 1
    <4>[ 1312.071349] save exit: isCheckpointed 1
    <4>[ 1312.254257] Enter wl_iw_control_wl_off
    <4>[ 1312.266749] Exit wl_iw_control_wl_off
    <4>[ 1312.319972] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1312.320277] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1312.339321] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1312.339629] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1312.382096] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1312.382841] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1318.071447] save exit: isCheckpointed 1
    <7>[ 1322.657819] wlan0: no IPv6 routers present
    <4>[ 1336.071834] save exit: isCheckpointed 1
    <4>[ 1414.073132] save exit: isCheckpointed 1
    <4>[ 1426.071407] save exit: isCheckpointed 1
    <4>[ 1450.071277] save exit: isCheckpointed 1
    <4>[ 1474.071546] save exit: isCheckpointed 1
    <4>[ 1564.071219] save exit: isCheckpointed 1
    <4>[ 1576.071231] save exit: isCheckpointed 1
    <4>[ 1678.071899] save exit: isCheckpointed 1
    <4>[ 1690.071519] save exit: isCheckpointed 1
    <4>[ 1696.071887] save exit: isCheckpointed 1
    <4>[ 1702.071399] save exit: isCheckpointed 1
    <4>[ 1708.072286] save exit: isCheckpointed 1
    <4>[ 1714.071414] save exit: isCheckpointed 1
    <4>[ 1720.071562] save exit: isCheckpointed 1
    <4>[ 1762.977045] Exited wl_iw_control_wl_on 
    <4>[ 1765.289920] STA connect received 1
    <4>[ 1765.778839] wl_iw_set_hostip: Received IP Address: 192.168.42.224
    <4>[ 1768.073165] save exit: isCheckpointed 1
    <4>[ 1768.260554] Enter wl_iw_control_wl_off
    <4>[ 1768.268284] Exit wl_iw_control_wl_off
    <4>[ 1768.319604] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1768.319915] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1768.329944] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1768.330239] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1768.366087] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1768.366405] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1774.071417] save exit: isCheckpointed 1
    <7>[ 1778.917840] wlan0: no IPv6 routers present
    <4>[ 1780.071555] save exit: isCheckpointed 1
    <4>[ 1792.071855] save exit: isCheckpointed 1
    <4>[ 1804.072362] save exit: isCheckpointed 1
    <4>[ 1834.074487] save exit: isCheckpointed 1
    <4>[ 1846.074515] save exit: isCheckpointed 1
    <4>[ 1876.071537] save exit: isCheckpointed 1
    <4>[ 1882.071155] save exit: isCheckpointed 1
    <4>[ 1918.720970] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1918.721330] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1918.829012] Exited wl_iw_control_wl_on 
    <4>[ 1923.962927] Enter wl_iw_control_wl_off
    <4>[ 1923.985250] Exit wl_iw_control_wl_off
    <4>[ 1924.028255] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1924.028570] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1924.036079] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1924.036369] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1924.086370] save exit: isCheckpointed 1
    <4>[ 1924.093542] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1924.093845] wl_iw_set_priv First IOCTL after stop is NOT START 
    <4>[ 1930.073035] save exit: isCheckpointed 1
    <7>[ 1934.317852] wlan0: no IPv6 routers present
    <4>[ 1935.962329] select 1492 (ndroid.settings), adj 9, size 3407, to kill
    <4>[ 1935.962395] select 1558 (com.android.mms), adj 11, size 2955, to kill
    <4>[ 1935.962469] send sigkill to 1558 (com.android.mms), adj 11, size 2955
    <4>[ 1942.073674] save exit: isCheckpointed 1
    <4>[ 1960.074435] save exit: isCheckpointed 1
...
There is a zip file with the CM7 firmware update. I mirrored it in <http://filez.zoobab.com/android/cyanogenmod/p350/cm-10.1-20130123-BETA-p350.zip>   . You can try to load it with the Android SDK fastboot utility:


    zoobab@turmes /home/zoobab/Downloads/adt-bundle-linux-x86_64-20130219/sdk/platform-tools [55]$ ./fastboot update /home/zoobab/soft/lg-p350/cm-10.1-20130123-BETA-p350.zip 
    < waiting for device >
