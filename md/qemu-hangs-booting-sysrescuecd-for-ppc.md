I am trying to boot the [Sysrescuecd ISO image](http://sourceforge.net/projects/systemrescuecd/files/sysresccd-ppc/0.2.0/sysresccd-ppc-0.2.0.iso/download) for PPC with Qemu-system-ppc:
